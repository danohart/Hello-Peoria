      ...
      <div>
        ...
        <ol type="a">
          ...
          <li>
            ...
            these restrictions and may be terminated by Hello Peoria at any
        ...
        <ol type="a">
          <li>
            ...
            intellectual property or other violation of rights. Further, Hello
            Peoria does not warrant or make any representations concerning the
        ...
        <p>
          In no event shall Hello Peoria or its suppliers be liable for any
          damages (including, without limitation, damages for loss of data or
          profit, or due to business interruption,) arising out of the use or
          inability to use the materials on Hello Peoria's Internet site, even
          if Hello Peoria or a Hello Peoria authorized representative has been
        ...
        <p>
          The materials appearing on Hello Peoria's web site could include
          technical, typographical, or photographic errors. Hello Peoria does
          not warrant that any of the materials on its web site are accurate,
          complete, or current. Hello Peoria may make changes to the materials
          contained on its web site at any time without notice. Hello Peoria
        ...
        <p>
          Hello Peoria has not reviewed all of the sites linked to its Internet
          web site and is not responsible for the contents of any such linked
          site. The inclusion of any link does not imply endorsement by Hello
          Peoria of the site. Use of any such linked web site is at the user's
          own risk.
        </p>
        ...
        <p>
          Hello Peoria may revise these terms of use for its web site at any
        ...
        <p>
          Any claim relating to Hello Peoria's web site shall be governed by the
